                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group mb-3">
                                    <input id="nip" type="text"
                                        ...
                                        name="nip" placeholder="Nomor Induk Pegawai (NIP)" value="{{ old('nip') }}"
                                        required>
                                ...
                                <div class="form-group mb-3">
                                    <input id="nip" type="text"
                                        class="form-control form-control-user @error('nip') is-invalid @enderror"
                                        name="nip" placeholder="Nomor HP" value="{{ old('nip') }}" required>
                                ...
                                <!-- Alamat -->
                                <div class="form-group mb-3">
                                    <textarea id="alamat" class="form-control form-control-user @error('alamat') is-invalid @enderror" name="alamat"
                                ...
                                <div class="form-group mb-3">
                                    <input id="agama" type="text"
                                        ...
                                        name="agama" placeholder="NIK (Nomor Induk Keluarga)" value="{{ old('agama') }}"
                                        required>
                                ...
                                <div class="form-group mb-3">
                                    <input id="ktp" type="text"
                                        ...
                                        name="ktp" placeholder="Nomor KTP" value="{{ old('ktp') }}" required>
                                ...
                                <div class="form-group mb-4">
                                    <input id="npwp" type="text"
                                        ...
                                        name="npwp" placeholder="Jabatan" value="{{ old('npwp') }}" required>
                                ...
                                <div class="form-group mb-4">
                                    <input id="npwp" type="text"
                                        class="form-control form-control-user @error('npwp') is-invalid @enderror"
                                        name="npwp" placeholder="Pendidikan Terakhir" value="{{ old('npwp') }}"
                                        required>
                                ...
                                <div class="form-group mb-4">
                                    <input id="npwp" type="text"
                                        class="form-control form-control-user @error('npwp') is-invalid @enderror"
                                        name="npwp" placeholder="Nomor NPWP" value="{{ old('npwp') }}" required>
